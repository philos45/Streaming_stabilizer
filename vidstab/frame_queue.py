...
class FrameQueue:
    ...
    def __init__(self, max_len=None, max_frames=None):
        ...
        self.frames = None#PopDeque(maxlen=max_len)
        self.inds = None #PopDeque(maxlen=max_len)
        self.i = None
        # self.source = None
    ...
    #     self.max_len = 3#max_len if max_len is not None else self.max_len
    #     self.max_frames = float('inf')#max_frames if max_frames is not None else self.max_frames
    ...
    #     print(float('inf'))
    #     print(self.max_frames == float('inf'))
    #     print("====")
    #     print(self.max_len)
        

    #     for i in range(2):
    #         self.read_frame(pop_ind=True)
